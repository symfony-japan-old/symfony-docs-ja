...
Doctrine でクエリするには、2つの選択肢があります。\
純粋な Doctrine クエリを書くか、Doctrine の Query Builder を使用することです。
...
一番大きな違いは、データベースの行ではなく、オブジェクトの観点から考える、というところでしょう。\
